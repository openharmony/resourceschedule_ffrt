...
API_ATTRIBUTE((visibility("default")))
void ffrt_submit_h_coroutine(void* co, ffrt_coroutine_ptr_t exec, ffrt_function_t destroy, const ffrt_deps_t* in_deps,
...
// API used to schedule stackless coroutin task
API_ATTRIBUTE((visibility("default")))
