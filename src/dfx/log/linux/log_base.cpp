...
void LogErr(const char* fmt, ...)
{
    ...
    va_list arg;
    va_start(arg, fmt);
    int ret = vsnprintf_s(errLog, sizeof(errLog) - 1, fmt, arg);
    va_end(arg);
    if (ret < 0) {
        return;
    }
...
void LogWarn(const char* fmt, ...)
{
    ...
    va_list arg;
    va_start(arg, fmt);
    int ret = vsnprintf_s(warnLog, sizeof(warnLog) - 1, fmt, arg);
    va_end(arg);
    if (ret < 0) {
        return;
    }
...
void LogInfo(const char* fmt, ...)
{
    ...
    va_list arg;
    va_start(arg, fmt);
    int ret = vsnprintf_s(infoLog, sizeof(infoLog) - 1, fmt, arg);
    va_end(arg);
    if (ret < 0) {
        return;
    }
...
void LogDebug(const char* fmt, ...)
{
    ...
    va_list arg;
    va_start(arg, fmt);
    int ret = vsnprintf_s(debugLog, sizeof(debugLog) - 1, fmt, arg);
    va_end(arg);
    if (ret < 0) {
        return;
    }
