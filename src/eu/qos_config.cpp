...
void QosConfig::setPolicySystem()
{
    g_systemServerQosPolicy = {
        ...
        .policys = {
            ...
            {0, 0, 1024, THREAD_AFFINITY_ALL, THREAD_PRIO_NORMAL_DEFAULT, 0, 0},
            {0, 0, 1024, THREAD_AFFINITY_ALL, THREAD_PRIO_NORMAL_FAVORABLE, 0, 0},
            {-10, 0, 1024, THREAD_AFFINITY_MID_BIG, THREAD_PRIO_NORMAL_FAVORABLE, 1, 1},
            {0, 0, 1024, THREAD_AFFINITY_ALL, THREAD_PRIO_NORMAL_FOREGROUND, 0, 0},
            {0, 0, 1024, THREAD_AFFINITY_ALL, THREAD_PRIO_NORMAL_URGENT, 0, 0},
            {0, 0, 1024, THREAD_AFFINITY_ALL, THREAD_PRIO_NORMAL_MAX, 0, 0},
